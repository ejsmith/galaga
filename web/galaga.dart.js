...
GalagaGame: {"": "Game;score@,highScore,lastPowerUp,lastEnemy,lastStar,_liblib5$_state,Stats<,Options<,Controls,Highscores<,HighscoresRank,Cheats<,rank,pointMultiplier@,enemyX?,enemyY?,bulletCap,shipStartLives,colorCount,enemyCount,enemyAmount@,defaultTimer,level@,p1Dead?,goingRight,_countdownTimer,_waitingTimer,_waiting@,difficulty@,bonusCheck@,bonusStage@,soundEffectsOn@,tutorial?,visualLevel<,ship<,nextId@,targetId@,menuSong<,optionSong,gameStart,gameSong,cursorMove<,cursorSelect<,cursorSelect2<,enemyFire<,enemyHit<,explosion,motherShipFire<,shipFire<,shipHit<,powerUp<,_statUpdateEvent<,_gameOverEvent,_shipHitEvent<,_bossHitEvent<,_bossKilledEvent,_motherShipEvent<,_normalHitEvent<,_fadeEvent<,entities,sounds,timer,clockTick,rect,input,renderer,loop,bgStyle,showOutlines",
  ...
  newStar$0: function() {
    var w, star;
    if ($.random(0, 1, false) > 0.09 || this._liblib5$_state === 2)
      return;
    w = $.random(0.5, 3.5, false);
  ...
  createCheatsMenu$0: function() {
    ...
    t2.opacity = 0.7;
    this.entities.push(t2);
    t1 = $.$eq(t1.$index(t1, "invincibility"), 1) ? "True" : "False";
    t1 = $.GameButton$(new $.GalagaGame_createCheatsMenu_closure0(this), true, "255, 255, 255", "cinnamoncake, Verdana", this, "cheats", "", 0.7, 36, t1, 200, -64);
    this.entities.push(t1);
    t1 = $.GameButton$(new $.GalagaGame_createCheatsMenu_closure1(this), true, "255, 255, 255", "cinnamoncake, Verdana", this, "cheats", "", 0.7, 16, "Made by Cody Smith", 400, 275);
    this.entities.push(t1);
    this.disableEntitiesByGroup$1("cheats");
  },
  ...
  createControlsMenu$0: function() {
    ...
    t2.opacity = 0.8;
    this.entities.push(t2);
    t1 = $.$eq(t1.$index(t1, "controls"), 1) ? "Super Bullet: Alt Key. (Needs 20 coins to charge.)" : "Super Bullet: Spacebar. (Needs 20 coins to charge.)";
...
Enemy: {"": "GameEntity;type>,startY,difficulty@,bossDifficulty,health@,bossHealth,maxHp,bossMaxHp,belowHalfHp,flicker@,enemyType<,idNum<,switchAmount,game,_x,_y,_width,_height,isHighlighted,soundReady,id,groupId,box,previousBox,_removeFromGame,radius,momentum,enabled,opacity,color,fill,sprite",
  update$0: function() {
    ...
    if (this.type === "Drone") {
      ...
      if ($.$gt$n(this._y, $.get$rect$x(this.game).get$halfHeight() - 16)) {
        t1 = this.momentum;
        t1.yVel = $.$mul$n(t1.yVel, -1);
      }
    ...
    if (this.type === "Normal") {
      ...
      if ($.$gt$n($.$add$ns(this._x, 16), $.get$rect$x(this.game).get$halfWidth()) || $.$lt$n($.$sub$n(this._x, 16), -$.get$rect$x(this.game).get$halfWidth()))
...
Ship: {"": "GameEntity;bulletPower,bullet@,maxBullet@,bulletsFired,bulletsHit@,lives@,soundLevel,chargedLevel@,superCharged,isPoweringUp,spiralShot@,invincible?,lastShotFired,_invincibleTimer,game,_x,_y,_width,_height,isHighlighted,soundReady,id,groupId,box,previousBox,_removeFromGame,radius,momentum,enabled,opacity,color,fill,sprite",
  update$0: function() {
    ...
    if ($.$gt$n(this.bullet, 0)) {
      ...
      if (t1)
        this.fire$0();
      if (this.game.get$input().isKeyJustPressed$1(18))
...
GalagaRenderer$: function(targetId) {
  var t1 = new $.GalagaRenderer(0, $.ImageElement_ImageElement(null, null, null), $.ImageElement_ImageElement(null, null, null), $.ImageElement_ImageElement(null, null, null), $.ImageElement_ImageElement(null, null, null), $.ImageElement_ImageElement(null, null, null), $.ImageElement_ImageElement(null, null, null), $.ImageElement_ImageElement(null, null, null), $.ImageElement_ImageElement(null, null, null), $.ImageElement_ImageElement(null, null, null), $.ImageElement_ImageElement(null, null, null), $.ImageElement_ImageElement(null, null, null), $.ImageElement_ImageElement(null, null, null), $.ImageElement_ImageElement(null, null, null), $.ImageElement_ImageElement(null, null, null), $.ImageElement_ImageElement(null, null, null), $.ImageElement_ImageElement(null, null, null), $.ImageElement_ImageElement(null, null, null), $.ImageElement_ImageElement(null, null, null), $.ImageElement_ImageElement(null, null, null), $.ImageElement_ImageElement(null, null, null), $.ImageElement_ImageElement(null, null, null), $.ImageElement_ImageElement(null, null, null), $.ImageElement_ImageElement(null, null, null), $.ImageElement_ImageElement(null, null, null), $.ImageElement_ImageElement(null, null, null), $.ImageElement_ImageElement(null, null, null), false, false, targetId, null, null, null, null, null, null, null, null);
