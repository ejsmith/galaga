...
$$._StreamImpl = {"": "Stream;_state@",
  ...
  _close$0: function() {
    ...
    if (!this.get$_mayFireState()) {
      this._addPendingEvent$1($.CONSTANT44);
      return;
    }
    if (this.get$_hasPendingEvent()) {
...
$$.Rect = {"": "Object;left>,top>,width>,height>",
  ...
  ceil$0: function(_) {
    return $.Rect$($.JSNumber_methods.ceil$0(this.left), $.JSNumber_methods.ceil$0(this.top), $.ceil$0$nx(this.width), $.ceil$0$nx(this.height));
  },
  round$0: function(_) {
...
$$.Game = {"": "Object;entities<,timer<,clockTick@,rect>,input<,renderer<,loop',bgStyle?",
  ...
  update$0: function() {
    ...
    for (t1 = $.JSArray_methods.where$1(this.entities, new $.Game_update_anon0()), t2 = $.JSArray_methods.get$iterator(t1.toList$0(t1)); t2.moveNext$0();) {
      t1 = t2.get$current();
      $.JSArray_methods.remove$1(this.entities, t1);
    }
  },
...
$$.GameButton = {"": "GameText;buttonAction,text,centered,font,size,game,_x,_y,_width,_height,isHighlighted,soundReady,id,groupId,box,previousBox,_removeFromGame,radius,momentum,enabled,opacity,color,fill,sprite",
  ...
  update$0: function() {
    ...
    if (t1) {
      this.opacity = 1;
      $.Timer_Timer($.CONSTANT16, new $.GameButton_update_anon(this));
      this.buttonAction$0();
    }
  },
...
$$.GameInput = {"": "Object;_downKeys<,_justPressedKeys<,click*,mouse@,mouseDown?,game<,keyDownEventStream<,keyUpEventStream<",
  ...
  get$onKeyDown: function(_) {
    return this.keyDownEventStream.stream;
  },
  get$onKeyUp: function(_) {
    return this.keyUpEventStream.stream;
  },
  GameInput$0: function() {
    this.get$onKeyDown(this).listen$1(new $.anon0(this));
    this.get$onKeyUp(this).listen$1(new $.anon1(this));
  }
};
...
$$.CanvasGameRenderer = {"": "GameRenderer;targetId@,ctx<",
  ...
  get$clicked: function() {
    return new $.BoundClosure$1(this, "clicked$1");
  },
  get$_pointerLocked: function() {
    var t1, t2;
    t1 = this.canvas;
    t2 = $.get$pointerLockElement$x($.document());
  ...
  get$pointerLockChange: function() {
    return new $.BoundClosure$1(this, "pointerLockChange$1");
  },
  CanvasGameRenderer$1: function(targetId) {
    var t1, clientRect, t2, t3;
    this.canvas = $.query("#" + $.S(this.targetId));
    $.get$onPointerLockChange$x($.document()).listen$1(this.get$pointerLockChange());
    $.get$onClick$x(this.canvas).listen$1(this.get$clicked());
...
$$.HtmlGameInput = {"": "GameInput;_downKeys,_justPressedKeys,click,mouse,mouseDown,game,keyDownEventStream,keyUpEventStream",
  start$0: function(_) {
    ...
    $.get$onKeyUp$x(document).listen$1(new $.HtmlGameInput_start_anon4(this));
    $.get$onMouseDown$x(document).listen$1(new $.HtmlGameInput_start_anon5(this));
    $.get$onMouseUp$x(document).listen$1(new $.HtmlGameInput_start_anon6(this));
  }
};
...
$$.HtmlGameInput_start_anon3 = {"": "Closure;this_7",
  call$1: function(e) {
    ...
    this.this_7.get$keyDownEventStream().signal$1($.GameKeyboardEvent$(t1.get$keyCode(e), t1.get$altKey(e), t1.get$ctrlKey(e), t1.get$shiftKey(e)));
  }
};
...
$$.HtmlGameInput_start_anon4 = {"": "Closure;this_8",
  call$1: function(e) {
    var t1 = $.getInterceptor$x(e);
    this.this_8.get$keyUpEventStream().signal$1($.GameKeyboardEvent$(t1.get$keyCode(e), t1.get$altKey(e), t1.get$ctrlKey(e), t1.get$shiftKey(e)));
  }
};
...
$$.HtmlGameInput_start_anon6 = {"": "Closure;this_10",
  call$1: function(e) {
...
$$.EventStream = {"": "Object;_controller,stream",
  ...
  EventStream$0: function() {
    this.stream = this._controller.stream.asBroadcastStream$0();
  }
};
...
$$.GalagaGame = {"": "Game;score@,highScore,lastPowerUp,lastEnemy,lastStar,_liblib3$_state,Stats<,Options<,Controls,Highscores<,HighscoresRank,Cheats<,rank,pointMultiplier@,enemyX?,enemyY?,bulletCap,shipStartLives,colorCount@,enemyCount,enemyAmount@,defaultTimer,level@,p1Dead?,goingRight<,_countdownTimer,_waitingTimer,_waiting@,difficulty@,bonusCheck@,bonusStage@,soundEffectsOn@,tutorial?,visualLevel<,ship<,nextId,targetId@,menuSong<,optionSong,gameStart,gameSong,cursorMove<,cursorSelect<,cursorSelect2<,enemyFire<,enemyHit<,explosion,motherShipFire<,shipFire<,shipHit<,powerUp<,_statUpdateEvent<,_gameOverEvent<,_shipHitEvent<,_bossHitEvent<,_bossKilledEvent,_motherShipEvent<,_normalHitEvent<,_fadeEvent<,entities,sounds,timer,clockTick,rect,input,renderer,loop,bgStyle,showOutlines",
  ...
  set$waiting: function(value) {
    ...
    this.disableEntitiesByGroup$1("leaders");
    this.disableEntitiesByGroup$1("cheats");
    this._waitingTimer = $.Timer_Timer$periodic($.CONSTANT42, new $.GalagaGame_waiting_anon(this));
  },
  start$0: function(_) {
    var t1, t2, i;
    t1 = this.Stats;
  ...
  update$0: function() {
    ...
    if (this.get$state(this) === 3 || this.get$state(this) === 2) {
      ...
      t1 = this.Stats;
      if ($.$gt$n(this.score, t1.$index(t1, "highscore")) === true)
        t1.$indexSet(t1, "highscore", this.score);
      if (this.get$state(this) === 3) {
        t2 = this.Options;
        t3 = $.$eq(t2.$index(t2, "soundeffects"), 1) === true;
        t2 = t3;
      } else
        t2 = false;
      if (t2)
  ...
  newBouncer$1: function(sprite) {
    ...
    if (sprite === 11) {
      bouncer.set$height(bouncer, 36);
      bouncer.set$width(bouncer, 36);
    }
  ...
  createCheatsMenu$0: function() {
    var t1, t2;
    t1 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "cheats", "", 0.8, 56, "Hax", 0, -240);
    this.entities.push(t1);
    t1 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "cheats", "", 0.7, 36, "SpreadShot:", -38, -94);
    this.entities.push(t1);
    t1 = this.Cheats;
    t2 = $.$eq(t1.$index(t1, "spreadshot"), 1) === true ? "True" : "False";
    t2 = $.GameButton$(new $.GalagaGame_createCheatsMenu_anon(this), true, "255, 255, 255", "cinnamoncake, Verdana", this, "cheats", "", 0.7, 36, t2, 200, -94);
    this.entities.push(t2);
    t2 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "cheats", "", 0.7, 36, "Invincibility:", -38, -64);
    this.entities.push(t2);
  ...
  createWelcomeMenu$0: function() {
    ...
    if ($.$le$n(t1.$index(t1, 1), 5000) === true && $.$ge$n(t1.$index(t1, 1), 0) === true)
      this.rank = 1;
    if ($.$le$n(t1.$index(t1, 1), 10000) === true && $.$ge$n(t1.$index(t1, 1), 5001) === true)
      this.rank = 2;
    if ($.$le$n(t1.$index(t1, 1), 15000) === true && $.$ge$n(t1.$index(t1, 1), 10001) === true)
      this.rank = 3;
    if ($.$le$n(t1.$index(t1, 1), 20000) === true && $.$ge$n(t1.$index(t1, 1), 15001) === true)
      this.rank = 4;
    if ($.$le$n(t1.$index(t1, 1), 25000) === true && $.$ge$n(t1.$index(t1, 1), 20001) === true)
      this.rank = 5;
    ...
    if ($.$le$n(t1.$index(t1, 1), 60000) === true && $.$ge$n(t1.$index(t1, 1), 55001) === true)
      this.rank = 12;
    if ($.$ge$n(t1.$index(t1, 1), 150000) === true && $.$ge$n(t1.$index(t1, 1), 100001) === true)
      this.rank = 13;
    if ($.$le$n(t1.$index(t1, 1), 200000) === true && $.$ge$n(t1.$index(t1, 1), 150001) === true)
      this.rank = 14;
    if ($.$le$n(t1.$index(t1, 1), 250000) === true && $.$ge$n(t1.$index(t1, 1), 200001) === true)
      this.rank = 15;
    if ($.$le$n(t1.$index(t1, 1), 300000) === true && $.$ge$n(t1.$index(t1, 1), 250001) === true)
      this.rank = 16;
    if ($.$ge$n(t1.$index(t1, 1), 400000) === true)
      this.rank = 17;
    t1 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "welcome", "", this.rank === 1 ? 0.8 : 0, 36, "You're: The Jew", 0, -275);
    this.entities.push(t1);
    t1 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "welcome", "", this.rank === 2 ? 0.8 : 0, 36, "You're: The Jewish Priest", 0, -275);
    this.entities.push(t1);
    t1 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "welcome", "", this.rank === 3 ? 0.8 : 0, 36, "You're: The Amish Mastermind", 0, -275);
    this.entities.push(t1);
    t1 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "welcome", "", this.rank === 4 ? 0.8 : 0, 36, "You're: The Road Warrior", 0, -275);
    this.entities.push(t1);
    t1 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "welcome", "", this.rank === 5 ? 0.8 : 0, 36, "You're: The Space Recruit", 0, -275);
    this.entities.push(t1);
    t1 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "welcome", "", this.rank === 6 ? 0.8 : 0, 36, "You're: The Space Cadet", 0, -275);
    this.entities.push(t1);
    t1 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "welcome", "", this.rank === 7 ? 0.8 : 0, 36, "You're: The Space Captain", 0, -275);
    this.entities.push(t1);
    t1 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "welcome", "", this.rank === 8 ? 0.8 : 0, 36, "You're: The Overlord of the Galaxy", 0, -275);
    this.entities.push(t1);
    t1 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "welcome", "", this.rank === 9 ? 0.8 : 0, 36, "You're: The President of the Universe", 0, -275);
    this.entities.push(t1);
    t1 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "welcome", "", this.rank === 10 ? 0.8 : 0, 36, "You're: The Commander of the Universe", 0, -275);
    this.entities.push(t1);
    t1 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "welcome", "", this.rank === 11 ? 0.8 : 0, 36, "You're: The Overlord of the Universe", 0, -275);
    this.entities.push(t1);
    t1 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "welcome", "", this.rank === 12 ? 0.8 : 0, 36, "You're: The Overseer of the Multi-verse", 0, -275);
    this.entities.push(t1);
    t1 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "welcome", "", this.rank === 13 ? 0.8 : 0, 36, "You're: The Commander of the Multi-verse", 0, -275);
    this.entities.push(t1);
    t1 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "welcome", "", this.rank === 14 ? 0.8 : 0, 36, "You're: The Overlord of the Multi-verse", 0, -275);
    this.entities.push(t1);
    t1 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "welcome", "", this.rank === 15 ? 0.8 : 0, 36, "You're: The God of this Dimension", 0, -275);
    this.entities.push(t1);
    t1 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "welcome", "", this.rank === 16 ? 0.8 : 0, 36, "You're: The God of all Dimensions", 0, -275);
    this.entities.push(t1);
    t1 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "welcome", "", this.rank === 17 ? 0.8 : 0, 36, "You're: Pablo Manrequez De Montoya De La Qruez the Third", 0, -275);
    this.entities.push(t1);
  ...
  createLeaderBoardMenu$0: function() {
    ...
    for (t1 = this.HighscoresRank, t2 = this.Highscores, i = 1; i < 11; ++i)
      if ($.$le$n(t2.$index(t2, i), 0) === true)
        t1.$indexSet(t1, i, "None");
      else if ($.$le$n(t2.$index(t2, i), 5000) === true && $.$gt$n(t2.$index(t2, i), 0) === true)
        t1.$indexSet(t1, i, "Jew");
      else if ($.$le$n(t2.$index(t2, i), 20000) === true && $.$ge$n(t2.$index(t2, i), 5001) === true)
        t1.$indexSet(t1, i, "Jewish Priest");
      else if ($.$le$n(t2.$index(t2, i), 35000) === true && $.$ge$n(t2.$index(t2, i), 20001) === true)
        t1.$indexSet(t1, i, "Amish Mastermind");
      else if ($.$le$n(t2.$index(t2, i), 45000) === true && $.$ge$n(t2.$index(t2, i), 35001) === true)
        t1.$indexSet(t1, i, "Road Warrior");
      else if ($.$le$n(t2.$index(t2, i), 65000) === true && $.$ge$n(t2.$index(t2, i), 45001) === true)
        t1.$indexSet(t1, i, "Space Recruit");
      else if ($.$le$n(t2.$index(t2, i), 80000) === true && $.$ge$n(t2.$index(t2, i), 65001) === true)
        t1.$indexSet(t1, i, "Space Cadet");
      else if ($.$le$n(t2.$index(t2, i), 90000) === true && $.$ge$n(t2.$index(t2, i), 80001) === true)
        t1.$indexSet(t1, i, "Space Captain");
      else if ($.$le$n(t2.$index(t2, i), 100000) === true && $.$ge$n(t2.$index(t2, i), 90001) === true)
        t1.$indexSet(t1, i, "Overlord of the Galaxy");
      else if ($.$le$n(t2.$index(t2, i), 150000) === true && $.$ge$n(t2.$index(t2, i), 100001) === true)
        t1.$indexSet(t1, i, "President of the Universe");
      else if ($.$le$n(t2.$index(t2, i), 200000) === true && $.$ge$n(t2.$index(t2, i), 150001) === true)
        t1.$indexSet(t1, i, "Commander of the Universe");
      else if ($.$le$n(t2.$index(t2, i), 250000) === true && $.$ge$n(t2.$index(t2, i), 200001) === true)
        t1.$indexSet(t1, i, "Overlord of the Universe");
      else if ($.$le$n(t2.$index(t2, i), 350000) === true && $.$ge$n(t2.$index(t2, i), 250001) === true)
        t1.$indexSet(t1, i, "Overseer of Multi-verse");
      else if ($.$le$n(t2.$index(t2, i), 450000) === true && $.$ge$n(t2.$index(t2, i), 350001) === true)
        t1.$indexSet(t1, i, "Commander of Multi-verse");
      else if ($.$le$n(t2.$index(t2, i), 500000) === true && $.$ge$n(t2.$index(t2, i), 450001) === true)
        t1.$indexSet(t1, i, "Overlord of Multi-verse");
      else if ($.$le$n(t2.$index(t2, i), 550000) === true && $.$ge$n(t2.$index(t2, i), 500001) === true)
        t1.$indexSet(t1, i, "God of this Dimension");
      else if ($.$le$n(t2.$index(t2, i), 700000) === true && $.$ge$n(t2.$index(t2, i), 550001) === true)
        t1.$indexSet(t1, i, "God of all Dimensions");
      else if ($.$ge$n(t2.$index(t2, i), 1000000) === true)
  ...
  createStatsMenu$0: function() {
    ...
    this.entities.push(t2);
    t2 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "stats", "", 0.6, 36, "Hit Rate: " + $.S(t1.$index(t1, "percentage")) + "%", 0, 25);
    this.entities.push(t2);
    t2 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "stats", "", 0.6, 36, "Total Completed Levels: " + $.S(t1.$index(t1, "wins")), 0, 70);
    this.entities.push(t2);
    t2 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "stats", "", 0.6, 36, "Total Loses: " + $.S(t1.$index(t1, "loses")), 0, 115);
    this.entities.push(t2);
    t2 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "stats", "", 0.6, 36, "Total Games: " + $.S(t1.$index(t1, "totalGames")), 0, 160);
    this.entities.push(t2);
    t2 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "stats", "", 0.6, 36, "High Score: " + $.S(t1.$index(t1, "highscore")), 0, 205);
    this.entities.push(t2);
    ...
    this.entities.push(t2);
    t2 = $.GameButton$(new $.GalagaGame_createStatsMenu_anon0(this), true, "255, 255, 255", "cinnamoncake, Verdana", this, "stats", "", 0.6, 36, "RESET", 0, 250);
    this.entities.push(t2);
    this.disableEntitiesByGroup$1("stats");
  },
  createOptionsMenu$0: function() {
    ...
    this.entities.push(t1);
    t1 = $.GameButton$(new $.GalagaGame_createOptionsMenu_anon(this), true, "255, 255, 255", "cinnamoncake, Verdana", this, "options", "", 0.5, 16, "Made by Cody Smith", 400, 275);
    this.entities.push(t1);
    t1 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "options", "", 0.7, 36, "Starting Lives:", 0, -60);
    this.entities.push(t1);
    t1 = this.Options;
    t2 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "options", "", 0.7, 36, $.S(t1.$index(t1, "startLives")), 200, -60);
    this.entities.push(t2);
    t2 = $.GameButton$(new $.GalagaGame_createOptionsMenu_anon0(this), true, "255, 255, 255", "cinnamoncake, Verdana", this, "options", "", 0.7, 36, "->", 245, -60);
    this.entities.push(t2);
    t2 = $.GameButton$(new $.GalagaGame_createOptionsMenu_anon1(this), true, "255, 255, 255", "cinnamoncake, Verdana", this, "options", "", 0.7, 36, "<-", 160, -60);
    this.entities.push(t2);
    t2 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "options", "", 0.7, 36, "Bullet Cap:", 0, -30);
    this.entities.push(t2);
    t2 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "options", "", 0.7, 36, $.S(t1.$index(t1, "bulletCap")), 200, -30);
    this.entities.push(t2);
    t2 = $.GameButton$(new $.GalagaGame_createOptionsMenu_anon2(this), true, "255, 255, 255", "cinnamoncake, Verdana", this, "options", "", 0.7, 36, "->", 245, -30);
    this.entities.push(t2);
    t2 = $.GameButton$(new $.GalagaGame_createOptionsMenu_anon3(this), true, "255, 255, 255", "cinnamoncake, Verdana", this, "options", "", 0.7, 36, "<-", 160, -30);
    this.entities.push(t2);
    t2 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "options", "", 0.7, 36, "Time:", 0, 0);
    this.entities.push(t2);
    t2 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "options", "", 0.7, 36, $.S(t1.$index(t1, "time")), 200, 0);
    this.entities.push(t2);
    t2 = $.GameButton$(new $.GalagaGame_createOptionsMenu_anon4(this), true, "255, 255, 255", "cinnamoncake, Verdana", this, "options", "", 0.7, 36, "->", 245, 0);
    this.entities.push(t2);
    t2 = $.GameButton$(new $.GalagaGame_createOptionsMenu_anon5(this), true, "255, 255, 255", "cinnamoncake, Verdana", this, "options", "", 0.7, 36, "<-", 160, 0);
    this.entities.push(t2);
    t2 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "options", "", 0.7, 36, "Difficulty:", 0, 30);
    this.entities.push(t2);
    t2 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "options", "", 0.7, 36, $.S(t1.$index(t1, "difficulty")), 200, 30);
    this.entities.push(t2);
    t2 = $.GameButton$(new $.GalagaGame_createOptionsMenu_anon6(this), true, "255, 255, 255", "cinnamoncake, Verdana", this, "options", "", 0.7, 36, "->", 245, 30);
    this.entities.push(t2);
    t2 = $.GameButton$(new $.GalagaGame_createOptionsMenu_anon7(this), true, "255, 255, 255", "cinnamoncake, Verdana", this, "options", "", 0.7, 36, "<-", 160, 30);
    this.entities.push(t2);
    t2 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "options", "", 0.7, 36, "Powerups Enabled:", -38, -94);
    this.entities.push(t2);
    t2 = $.$eq(t1.$index(t1, "powerups"), 1) === true ? "True" : "False";
    t2 = $.GameButton$(new $.GalagaGame_createOptionsMenu_anon8(this), true, "255, 255, 255", "cinnamoncake, Verdana", this, "options", "", 0.7, 36, t2, 200, -94);
    this.entities.push(t2);
    t2 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "options", "", 0.7, 36, "Sound Effects Enabled:", -38, 60);
    this.entities.push(t2);
    t2 = $.$eq(t1.$index(t1, "soundeffects"), 1) === true ? "True" : "False";
    t2 = $.GameButton$(new $.GalagaGame_createOptionsMenu_anon9(this), true, "255, 255, 255", "cinnamoncake, Verdana", this, "options", "", 0.7, 36, t2, 200, 60);
    this.entities.push(t2);
    t2 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "options", "", 0.7, 36, "Input Type:", 0, 90);
    this.entities.push(t2);
    ...
    this.entities.push(t1);
    t1 = $.GameButton$(new $.GalagaGame_createOptionsMenu_anon11(this), true, "255, 255, 255", "cinnamoncake, Verdana", this, "options", "", 0.7, 36, "Set to Defaults", 10, 150);
    this.entities.push(t1);
  ...
  createControlsMenu$0: function() {
    ...
    this.entities.push(t1);
    t1 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "instructions", "", 0.6, 24, "Fire Flower: Spread shot upgrade.", 0, 51);
    this.entities.push(t1);
    t1 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "instructions", "", 0.6, 24, "Energy Canister: Extra life.", 0, 100);
    this.entities.push(t1);
    t1 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "instructions", "", 0.6, 24, "Apple: Multiplier times two.", 0, 149);
    this.entities.push(t1);
    t1 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "instructions", "", 0.6, 24, "Energy Ball: Extra bullet", 0, 198);
    this.entities.push(t1);
    t1 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "instructions", "", 0.6, 24, "Coin: Plus 100 points.", 0, 247);
    this.entities.push(t1);
  ...
  updateLeaderboard$0: function() {
    ...
    for (i = 1; i <= 10; ++i)
      if ($.$gt$n(this.score, t1.$index(t1, i)) === true) {
        for (j = i + 1; j < 10; ++j)
  ...
  newGame$0: function() {
    ...
    if ($.$eq(t1.$index(t1, "powerups"), 1) === true)
    ...
    this.p1Dead = false;
    t2 = this.Cheats;
    t3 = $.$eq(t2.$index(t2, "spreadshot"), 1);
    t4 = this.ship;
    if (t3 === true)
      t4.spiralShot = true;
    else
...
$$.GalagaGame_createCheatsMenu_anon = {"": "Closure;this_0",
  call$0: function() {
    var t1, t2, t3, t4;
    t1 = this.this_0;
    t2 = t1.get$Cheats();
    t3 = $.$ge$n(t2.$index(t2, "spreadshot"), 2);
    t4 = t1.get$Cheats();
    if (t3 === true)
      t4.$indexSet(t4, "spreadshot", 1);
    else
      t4.$indexSet(t4, "spreadshot", $.$add$ns(t4.$index(t4, "spreadshot"), 1));
...
$$.GalagaGame_createCheatsMenu_anon0 = {"": "Closure;this_1",
  call$0: function() {
    ...
    t1 = this.this_1;
    t2 = t1.get$Cheats();
    t3 = $.$ge$n(t2.$index(t2, "invincibility"), 2);
    t4 = t1.get$Cheats();
    if (t3 === true)
      t4.$indexSet(t4, "invincibility", 1);
    else
      t4.$indexSet(t4, "invincibility", $.$add$ns(t4.$index(t4, "invincibility"), 1));
    t1.get$_statUpdateEvent().signal$0();
    t2 = $.getInterceptor$x(t1);
    t2.set$state(t1, 1);
    t1.removeEntitiesByGroup$1("cheats");
...
$$.GalagaGame_createLeaderBoardMenu_anon0 = {"": "Closure;this_1",
  call$0: function() {
    var t1 = this.this_1;
    t1.removeEntitiesByGroup$1("welcome");
    t1.createWelcomeMenu$0();
...
$$.GalagaGame_createOptionsMenu_anon1 = {"": "Closure;this_2",
  call$0: function() {
    ...
    t1 = this.this_2;
    t2 = t1.get$Options();
    t3 = $.$le$n(t2.$index(t2, "startLives"), 1);
    t4 = t1.get$Options();
    if (t3 === true)
      t4.$indexSet(t4, "startLives", 10);
    else
      t4.$indexSet(t4, "startLives", $.$sub$n(t4.$index(t4, "startLives"), 1));
    t1.get$_statUpdateEvent().signal$0();
    t2 = $.getInterceptor$x(t1);
    t2.set$state(t1, 1);
    t1.removeEntitiesByGroup$1("options");
...
$$.GalagaGame_createOptionsMenu_anon3 = {"": "Closure;this_4",
  call$0: function() {
    ...
    t1 = this.this_4;
    t2 = t1.get$Options();
    t3 = $.$le$n(t2.$index(t2, "bulletCap"), 1);
    t4 = t1.get$Options();
    if (t3 === true)
      t4.$indexSet(t4, "bulletCap", 10);
    else
      t4.$indexSet(t4, "bulletCap", $.$sub$n(t4.$index(t4, "bulletCap"), 1));
    t1.get$_statUpdateEvent().signal$0();
    t2 = $.getInterceptor$x(t1);
    t2.set$state(t1, 1);
    t1.removeEntitiesByGroup$1("options");
...
$$.GalagaGame_createOptionsMenu_anon5 = {"": "Closure;this_6",
  call$0: function() {
    ...
    t1 = this.this_6;
    t2 = t1.get$Options();
    t3 = $.$le$n(t2.$index(t2, "time"), 0);
    t4 = t1.get$Options();
    if (t3 === true)
      t4.$indexSet(t4, "time", 180);
    else
      t4.$indexSet(t4, "time", $.$sub$n(t4.$index(t4, "time"), 20));
    t1.get$_statUpdateEvent().signal$0();
    t2 = $.getInterceptor$x(t1);
    t2.set$state(t1, 1);
    t1.removeEntitiesByGroup$1("options");
...
$$.GalagaGame_createOptionsMenu_anon7 = {"": "Closure;this_8",
  call$0: function() {
    ...
    t1 = this.this_8;
    t2 = t1.get$Options();
    t3 = $.$le$n(t2.$index(t2, "difficulty"), 1);
    t4 = t1.get$Options();
    if (t3 === true)
      t4.$indexSet(t4, "difficulty", 5);
    else
      t4.$indexSet(t4, "difficulty", $.$sub$n(t4.$index(t4, "difficulty"), 1));
    t1.get$_statUpdateEvent().signal$0();
    t2 = $.getInterceptor$x(t1);
    t2.set$state(t1, 1);
    t1.removeEntitiesByGroup$1("options");
...
$$.GalagaGame_createOptionsMenu_anon8 = {"": "Closure;this_9",
  call$0: function() {
    var t1, t2, t3, t4;
    t1 = this.this_9;
    t2 = t1.get$Options();
...
$$.GalagaGame_createOptionsMenu_anon9 = {"": "Closure;this_10",
  call$0: function() {
    var t1, t2, t3, t4;
    t1 = this.this_10;
    t2 = t1.get$Options();
...
$$.GalagaGame_createOptionsMenu_anon10 = {"": "Closure;this_11",
  call$0: function() {
    var t1, t2, t3, t4;
    t1 = this.this_11;
    t2 = t1.get$Options();
    t3 = $.$ge$n(t2.$index(t2, "controls"), 2);
    t4 = t1.get$Options();
    if (t3 === true)
      t4.$indexSet(t4, "controls", 1);
    else
      t4.$indexSet(t4, "controls", $.$add$ns(t4.$index(t4, "controls"), 1));
    t2 = t1.get$menuSong();
    t2.remove$0(t2);
    t1.get$_statUpdateEvent().signal$0();
    t2 = $.getInterceptor$x(t1);
...
$$.GalagaGame_createOptionsMenu_anon11 = {"": "Closure;this_12",
  call$0: function() {
...
$$.GalagaGame_createOptionsMenu_anon13 = {"": "Closure;this_14",
  call$0: function() {
    var t1 = this.this_14;
    t1.removeEntitiesByGroup$1("welcome");
    t1.createWelcomeMenu$0();
...
$$.bouncingBall = {"": "GameEntity;Sprite<,game,_x,_y,_width,_height,isHighlighted,soundReady,id,groupId,box,previousBox,_removeFromGame,radius,momentum,enabled,opacity,color,fill,sprite",
  update$0: function() {
    if ($.$eq($.get$state$x(this.game), 7) !== true && $.$eq($.get$state$x(this.game), 10) !== true)
      this._removeFromGame = true;
    if ($.$gt$n(this.get$y(this), $.get$rect$x(this.game).get$halfHeight() - $.$div$n(this.get$height(this), 2)) === true) {
      var t1 = this.momentum;
      t1.yVel = $.$mul$n(t1.yVel, -1);
    }
    if ($.$lt$n(this.get$y(this), -$.get$rect$x(this.game).get$halfHeight() + $.$div$n(this.get$height(this), 2)) === true) {
      t1 = this.momentum;
      t1.yVel = $.$mul$n(t1.yVel, -1);
    }
    if ($.$gt$n(this.get$x(this), $.get$rect$x(this.game).get$halfWidth() - $.$div$n(this.get$width(this), 2)) === true) {
      t1 = this.momentum;
      t1.xVel = $.$mul$n(t1.xVel, -1);
    }
    if ($.$lt$n(this.get$x(this), -$.get$rect$x(this.game).get$halfWidth() + $.$div$n(this.get$width(this), 2)) === true) {
      t1 = this.momentum;
      t1.xVel = $.$mul$n(t1.xVel, -1);
    }
    $.GameEntity.prototype.update$0.call(this);
...
$$.Bullet = {"": "GameEntity;temp,startX,Type<,_deleteTimer,_waiting@,farRight,farLeft,right,left,straight,game,_x,_y,_width,_height,isHighlighted,soundReady,id,groupId,box,previousBox,_removeFromGame,radius,momentum,enabled,opacity,color,fill,sprite",
  update$0: function() {
    ...
    if ($.$eq(this.momentum.yVel, 0) !== true) {
      t1 = $.JSArray_methods.where$1(this.game.get$entities(), new $.Bullet_update_anon(this));
      $.JSArray_methods.forEach$1(t1.toList$0(t1), new $.Bullet_update_anon0(this));
    }
    if ($.$lt$n(this.momentum.yVel, 0) === true) {
      t1 = $.JSArray_methods.where$1(this.game.get$entities(), new $.Bullet_update_anon1(this));
      $.JSArray_methods.forEach$1(t1.toList$0(t1), new $.Bullet_update_anon2(this));
    }
    if ($.$gt$n(this.momentum.yVel, 0) === true) {
      t1 = $.JSArray_methods.where$1(this.game.get$entities(), new $.Bullet_update_anon3(this));
      $.JSArray_methods.forEach$1(t1.toList$0(t1), new $.Bullet_update_anon4(this));
    }
  },
...
$$.Bullet_update_anon = {"": "Closure;this_0",
  call$1: function(e) {
    return typeof e === "object" && e !== null && !!e.$isBullet && this.this_0.collidesWith$1(e);
  }
};
...
$$.Bullet_update_anon1 = {"": "Closure;this_2",
  call$1: function(e) {
    return typeof e === "object" && e !== null && !!e.$isEnemy && this.this_2.collidesWith$1(e);
  }
};
...
$$.Bullet_update_anon2 = {"": "Closure;this_3",
  call$1: function(enemy) {
    ...
    t2 = t1.get$game().get$ship();
    t2.set$bulletsHit(t2.get$bulletsHit() + 1);
...
$$.Bullet_update_anon3 = {"": "Closure;this_4",
  call$1: function(e) {
    return typeof e === "object" && e !== null && !!e.$isShip && this.this_4.collidesWith$1(e);
  }
};
...
$$.Bullet_update_anon4 = {"": "Closure;this_5",
  call$1: function(e) {
    ...
    if ($.$eq(t2.$index(t2, "invincibility"), 1) === true) {
      t2 = t1.get$game().get$ship();
...
$$.Enemy = {"": "GameEntity;type>,yReset,isFalling<,creationTime,startY,difficulty@,bossDifficulty,health@,bossHealth,maxHp,bossMaxHp,belowHalfHp,flicker@,enemyType<,idNum<,game,_x,_y,_width,_height,isHighlighted,soundReady,id,groupId,box,previousBox,_removeFromGame,radius,momentum,enabled,opacity,color,fill,sprite",
  update$0: function() {
    var t1, t2;
    if ($.$eq($.get$state$x(this.game), 2) === true || $.$eq($.get$state$x(this.game), 4) === true || $.$eq($.get$state$x(this.game), 1) === true)
      return;
...
$$.GalagaRenderer = {"": "CanvasGameRenderer;timeLeft,ship<,enemy<,enemy2<,boss<,mothership<,bosshp<,spreadup<,lifeup<,multiplierup<,bulletup<,coin<,shipbullet<,enemybullet<,superBullet<,bossSuperBullet<,chargeBar,star1<,star2<,star3<,star4<,star5<,star6<,star7<,skull<,enemyFlicker,shipFlicker?,targetId,ctx,defaultRenderer,assetManager,textRenderer,ownMouse,canvas,_game,rect",
  init$0: function() {
    ...
    t1 = this.get$game().get$Stats();
    t1.$indexSet(t1, "normalKills", $.containsKey$1$x(window.localStorage, "win13") ? $.int_parse($.$index$asx(window.localStorage, "win13"), null, null) : 0);
    t1 = this.get$game().get$Stats();
    t1.$indexSet(t1, "bossKills", $.containsKey$1$x(window.localStorage, "win14") ? $.int_parse($.$index$asx(window.localStorage, "win14"), null, null) : 0);
    t1 = this.get$game().get$Stats();
    t1.$indexSet(t1, "motherKills", $.containsKey$1$x(window.localStorage, "win15") ? $.int_parse($.$index$asx(window.localStorage, "win15"), null, null) : 0);
    t1 = this.get$game().get$Stats();
    t1.$indexSet(t1, "powerups", $.containsKey$1$x(window.localStorage, "win16") ? $.int_parse($.$index$asx(window.localStorage, "win16"), null, null) : 0);
    t1 = this.get$game().get$Stats();
    t1.$indexSet(t1, "percentage", $.containsKey$1$x(window.localStorage, "win17") ? $.int_parse($.$index$asx(window.localStorage, "win17"), null, null) : 0);
    ...
    t1 = this.get$game().get$Options();
    t1.$indexSet(t1, "controls", $.containsKey$1$x(window.localStorage, "win12") ? $.int_parse($.$index$asx(window.localStorage, "win12"), null, null) : 1);
    t1 = this.get$game().get$Highscores();
    t1.$indexSet(t1, 1, $.containsKey$1$x(window.localStorage, "win18") ? $.int_parse($.$index$asx(window.localStorage, "win18"), null, null) : 0);
    t1 = this.get$game().get$Highscores();
    t1.$indexSet(t1, 2, $.containsKey$1$x(window.localStorage, "win19") ? $.int_parse($.$index$asx(window.localStorage, "win19"), null, null) : 0);
    t1 = this.get$game().get$Highscores();
    t1.$indexSet(t1, 3, $.containsKey$1$x(window.localStorage, "win20") ? $.int_parse($.$index$asx(window.localStorage, "win20"), null, null) : 0);
    t1 = this.get$game().get$Highscores();
    t1.$indexSet(t1, 4, $.containsKey$1$x(window.localStorage, "win21") ? $.int_parse($.$index$asx(window.localStorage, "win21"), null, null) : 0);
    t1 = this.get$game().get$Highscores();
    t1.$indexSet(t1, 5, $.containsKey$1$x(window.localStorage, "win22") ? $.int_parse($.$index$asx(window.localStorage, "win22"), null, null) : 0);
    t1 = this.get$game().get$Highscores();
    t1.$indexSet(t1, 6, $.containsKey$1$x(window.localStorage, "win23") ? $.int_parse($.$index$asx(window.localStorage, "win23"), null, null) : 0);
    t1 = this.get$game().get$Highscores();
    t1.$indexSet(t1, 7, $.containsKey$1$x(window.localStorage, "win24") ? $.int_parse($.$index$asx(window.localStorage, "win24"), null, null) : 0);
    t1 = this.get$game().get$Highscores();
    t1.$indexSet(t1, 8, $.containsKey$1$x(window.localStorage, "win25") ? $.int_parse($.$index$asx(window.localStorage, "win25"), null, null) : 0);
    t1 = this.get$game().get$Highscores();
    t1.$indexSet(t1, 9, $.containsKey$1$x(window.localStorage, "win26") ? $.int_parse($.$index$asx(window.localStorage, "win26"), null, null) : 0);
    t1 = this.get$game().get$Highscores();
  ...
  drawChargeBar$0: function() {
    ...
    $.drawImageScaled$5$x(this.ctx, this.chargeBar, -300, -224, this.get$game().get$ship().chargedLevel * 15, 12);
    $.stroke$0$x(this.ctx);
  },
  drawShip$0: function() {
    var t1, t2, t3, t4, t5;
  ...
  updateStats$0: function() {
    ...
    t1 = window.localStorage;
    t11 = this.get$game().get$Stats();
    $.$indexSet$ax(t1, "win16", $.toString$0(t11.$index(t11, "percentage")));
    t1 = window.localStorage;
    t12 = this.get$game().get$Options();
    $.$indexSet$ax(t1, "win6", $.toString$0(t12.$index(t12, "startLives")));
    t1 = window.localStorage;
    t13 = this.get$game().get$Options();
    $.$indexSet$ax(t1, "win7", $.toString$0(t13.$index(t13, "bulletCap")));
    t1 = window.localStorage;
    t14 = this.get$game().get$Options();
    $.$indexSet$ax(t1, "win8", $.toString$0(t14.$index(t14, "time")));
    t1 = window.localStorage;
    t15 = this.get$game().get$Options();
    $.$indexSet$ax(t1, "win9", $.toString$0(t15.$index(t15, "difficulty")));
    t1 = window.localStorage;
    t16 = this.get$game().get$Options();
    $.$indexSet$ax(t1, "win10", $.toString$0(t16.$index(t16, "powerups")));
    t1 = window.localStorage;
    t17 = this.get$game().get$Options();
    $.$indexSet$ax(t1, "win11", $.toString$0(t17.$index(t17, "soundeffects")));
    t1 = window.localStorage;
    t18 = this.get$game().get$Highscores();
    $.$indexSet$ax(t1, "win17", $.toString$0(t18.$index(t18, 1)));
    t1 = window.localStorage;
    t19 = this.get$game().get$Highscores();
    $.$indexSet$ax(t1, "win18", $.toString$0(t19.$index(t19, 2)));
    t1 = window.localStorage;
    t20 = this.get$game().get$Highscores();
    $.$indexSet$ax(t1, "win19", $.toString$0(t20.$index(t20, 3)));
    t1 = window.localStorage;
    t21 = this.get$game().get$Highscores();
    $.$indexSet$ax(t1, "win20", $.toString$0(t21.$index(t21, 4)));
    t1 = window.localStorage;
    t22 = this.get$game().get$Highscores();
    $.$indexSet$ax(t1, "win21", $.toString$0(t22.$index(t22, 5)));
    t1 = window.localStorage;
    t23 = this.get$game().get$Highscores();
    $.$indexSet$ax(t1, "win22", $.toString$0(t23.$index(t23, 6)));
    t1 = window.localStorage;
    t24 = this.get$game().get$Highscores();
    $.$indexSet$ax(t1, "win23", $.toString$0(t24.$index(t24, 7)));
    t1 = window.localStorage;
    t25 = this.get$game().get$Highscores();
    $.$indexSet$ax(t1, "win24", $.toString$0(t25.$index(t25, 8)));
    t1 = window.localStorage;
    t26 = this.get$game().get$Highscores();
    $.$indexSet$ax(t1, "win25", $.toString$0(t26.$index(t26, 9)));
    t1 = window.localStorage;
    t27 = this.get$game().get$Highscores();
    $.$indexSet$ax(t1, "win26", $.toString$0(t27.$index(t27, 10)));
  },
  bossHit$0: function() {
  ...
  drawCountDown$0: function() {
    ...
    if (t1.get$state(t1) === 8) {
      $.set$fillStyle$x(this.ctx, "rgba(255, 255, 255, 1)");
      $.set$font$x(this.ctx, "52px cinnamoncake, Verdana");
      temp = this.get$game().get$waiting() === 1 ? 3 : 0;
      if (this.get$game().get$waiting() === 2)
        temp = 2;
      if (this.get$game().get$waiting() === 3)
        temp = 1;
  ...
  subtleBgFade$0: function() {
    ...
    $.Timer_Timer($.CONSTANT27, new $.GalagaRenderer_subtleBgFade_anon6(this));
    $.Timer_Timer($.CONSTANT21, new $.GalagaRenderer_subtleBgFade_anon7(this));
    $.Timer_Timer($.CONSTANT26, new $.GalagaRenderer_subtleBgFade_anon8(this));
    $.Timer_Timer($.CONSTANT27, new $.GalagaRenderer_subtleBgFade_anon9(this));
    $.Timer_Timer($.CONSTANT21, new $.GalagaRenderer_subtleBgFade_anon10(this));
    $.Timer_Timer($.CONSTANT26, new $.GalagaRenderer_subtleBgFade_anon11(this));
    $.Timer_Timer($.CONSTANT27, new $.GalagaRenderer_subtleBgFade_anon12(this));
    $.Timer_Timer($.CONSTANT21, new $.GalagaRenderer_subtleBgFade_anon13(this));
    $.Timer_Timer($.CONSTANT16, new $.GalagaRenderer_subtleBgFade_anon14(this));
    $.Timer_Timer($.CONSTANT28, new $.GalagaRenderer_subtleBgFade_anon15(this));
    $.Timer_Timer($.CONSTANT22, new $.GalagaRenderer_subtleBgFade_anon16(this));
    $.Timer_Timer($.CONSTANT29, new $.GalagaRenderer_subtleBgFade_anon17(this));
    $.Timer_Timer($.CONSTANT30, new $.GalagaRenderer_subtleBgFade_anon18(this));
    $.Timer_Timer($.CONSTANT23, new $.GalagaRenderer_subtleBgFade_anon19(this));
    $.Timer_Timer($.CONSTANT31, new $.GalagaRenderer_subtleBgFade_anon20(this));
    $.Timer_Timer($.CONSTANT32, new $.GalagaRenderer_subtleBgFade_anon21(this));
    $.Timer_Timer($.CONSTANT33, new $.GalagaRenderer_subtleBgFade_anon22(this));
    $.Timer_Timer($.CONSTANT34, new $.GalagaRenderer_subtleBgFade_anon23(this));
    $.Timer_Timer($.CONSTANT35, new $.GalagaRenderer_subtleBgFade_anon24(this));
    $.Timer_Timer($.CONSTANT36, new $.GalagaRenderer_subtleBgFade_anon25(this));
    $.Timer_Timer($.CONSTANT37, new $.GalagaRenderer_subtleBgFade_anon26(this));
    $.Timer_Timer($.CONSTANT38, new $.GalagaRenderer_subtleBgFade_anon27(this));
    $.Timer_Timer($.CONSTANT39, new $.GalagaRenderer_subtleBgFade_anon28(this));
    $.Timer_Timer($.CONSTANT40, new $.GalagaRenderer_subtleBgFade_anon29(this));
    $.Timer_Timer($.CONSTANT41, new $.GalagaRenderer_subtleBgFade_anon30(this));
  },
  bgFade$0: function() {
    ...
    $.Timer_Timer($.CONSTANT16, new $.GalagaRenderer_bgFade_anon8(this));
...
$$.GalagaRenderer_drawStars_anon0 = {"": "Closure;this_0",
  call$1: function(e) {
    var t1, t2;
...
$$.GalagaRenderer_drawBullets_anon0 = {"": "Closure;this_0",
  call$1: function(e) {
    ...
    if ($.$lt$n(e.get$momentum().yVel, 0) === true && e.get$Type() === "super") {
      ...
      $.stroke$0$x(t1.get$ctx());
    } else if ($.$gt$n(e.get$momentum().yVel, 0) === true && e.get$Type() === "super") {
      t1 = this.this_0;
      $.set$strokeStyle$x(t1.get$ctx(), "rgba(255, 255, 255, 1.0)");
      $.set$lineWidth$x(t1.get$ctx(), 3);
      $.beginPath$0$x(t1.get$ctx());
      ...
      $.stroke$0$x(t1.get$ctx());
    } else if ($.$lt$n(e.get$momentum().yVel, 0) === true && e.get$Type() !== "super") {
      t1 = this.this_0;
      $.set$strokeStyle$x(t1.get$ctx(), "rgba(255, 255, 255, 1.0)");
      $.set$lineWidth$x(t1.get$ctx(), 3);
      $.beginPath$0$x(t1.get$ctx());
...
$$.GalagaRenderer_drawEnemys_anon0 = {"": "Closure;this_0",
  call$1: function(e) {
    ...
    if ($.$eq(t1.get$type(e), "Normal") === true && !e.get$flicker()) {
      ...
      t4 = t2.get$ctx();
      if (t3 > 0.5)
        $.drawImageScaled$5$x(t4, t2.get$enemy(), $.$sub$n(t1.get$x(e), 22), $.$sub$n(t1.get$y(e), 25), 42, 42);
      else
...
$$.GalagaRenderer_subtleBgFade_anon0 = {"": "Closure;this_1",
  call$0: function() {
    this.this_1.get$game().set$bgStyle("rgba(0, 0, 0, 0.81)");
...
$$.GalagaRenderer_subtleBgFade_anon1 = {"": "Closure;this_2",
  call$0: function() {
    this.this_2.get$game().set$bgStyle("rgba(0, 0, 0, 0.79)");
...
$$.GalagaRenderer_subtleBgFade_anon2 = {"": "Closure;this_3",
  call$0: function() {
    this.this_3.get$game().set$bgStyle("rgba(0, 0, 0, 0.77)");
...
$$.GalagaRenderer_subtleBgFade_anon3 = {"": "Closure;this_4",
  call$0: function() {
    this.this_4.get$game().set$bgStyle("rgba(0, 0, 0, 0.75)");
...
$$.GalagaRenderer_subtleBgFade_anon4 = {"": "Closure;this_5",
  call$0: function() {
    this.this_5.get$game().set$bgStyle("rgba(0, 0, 0, 0.73)");
...
$$.GalagaRenderer_subtleBgFade_anon5 = {"": "Closure;this_6",
  call$0: function() {
    this.this_6.get$game().set$bgStyle("rgba(0, 0, 0, 0.71)");
    return "rgba(0, 0, 0, 0.71)";
  }
};

$$.GalagaRenderer_subtleBgFade_anon6 = {"": "Closure;this_7",
  call$0: function() {
    this.this_7.get$game().set$bgStyle("rgba(0, 0, 0, 0.69)");
    return "rgba(0, 0, 0, 0.69)";
  }
};

$$.GalagaRenderer_subtleBgFade_anon7 = {"": "Closure;this_8",
  call$0: function() {
    this.this_8.get$game().set$bgStyle("rgba(0, 0, 0, 0.67)");
    return "rgba(0, 0, 0, 0.67)";
  }
};

$$.GalagaRenderer_subtleBgFade_anon8 = {"": "Closure;this_9",
  call$0: function() {
    this.this_9.get$game().set$bgStyle("rgba(0, 0, 0, 0.65)");
    return "rgba(0, 0, 0, 0.65)";
  }
};

$$.GalagaRenderer_subtleBgFade_anon9 = {"": "Closure;this_10",
  call$0: function() {
    this.this_10.get$game().set$bgStyle("rgba(0, 0, 0, 0.63)");
    return "rgba(0, 0, 0, 0.63)";
  }
};

$$.GalagaRenderer_subtleBgFade_anon10 = {"": "Closure;this_11",
  call$0: function() {
    this.this_11.get$game().set$bgStyle("rgba(0, 0, 0, 0.61)");
    return "rgba(0, 0, 0, 0.61)";
  }
};

$$.GalagaRenderer_subtleBgFade_anon11 = {"": "Closure;this_12",
  call$0: function() {
    this.this_12.get$game().set$bgStyle("rgba(0, 0, 0, 0.59)");
    return "rgba(0, 0, 0, 0.59)";
  }
};

$$.GalagaRenderer_subtleBgFade_anon12 = {"": "Closure;this_13",
  call$0: function() {
    this.this_13.get$game().set$bgStyle("rgba(0, 0, 0, 0.57)");
    return "rgba(0, 0, 0, 0.57)";
  }
};

$$.GalagaRenderer_subtleBgFade_anon13 = {"": "Closure;this_14",
  call$0: function() {
    this.this_14.get$game().set$bgStyle("rgba(0, 0, 0, 0.55)");
    return "rgba(0, 0, 0, 0.55)";
  }
};

$$.GalagaRenderer_subtleBgFade_anon14 = {"": "Closure;this_15",
  call$0: function() {
    this.this_15.get$game().set$bgStyle("rgba(0, 0, 0, 0.53)");
    return "rgba(0, 0, 0, 0.53)";
  }
};

$$.GalagaRenderer_subtleBgFade_anon15 = {"": "Closure;this_16",
  call$0: function() {
    this.this_16.get$game().set$bgStyle("rgba(0, 0, 0, 0.55)");
    return "rgba(0, 0, 0, 0.55)";
  }
};

$$.GalagaRenderer_subtleBgFade_anon16 = {"": "Closure;this_17",
  call$0: function() {
    this.this_17.get$game().set$bgStyle("rgba(0, 0, 0, 0.57)");
    return "rgba(0, 0, 0, 0.57)";
  }
};

$$.GalagaRenderer_subtleBgFade_anon17 = {"": "Closure;this_18",
  call$0: function() {
    this.this_18.get$game().set$bgStyle("rgba(0, 0, 0, 0.59)");
    return "rgba(0, 0, 0, 0.59)";
  }
};

$$.GalagaRenderer_subtleBgFade_anon18 = {"": "Closure;this_19",
  call$0: function() {
    this.this_19.get$game().set$bgStyle("rgba(0, 0, 0, 0.61)");
    return "rgba(0, 0, 0, 0.61)";
  }
};

$$.GalagaRenderer_subtleBgFade_anon19 = {"": "Closure;this_20",
  call$0: function() {
    this.this_20.get$game().set$bgStyle("rgba(0, 0, 0, 0.63)");
    return "rgba(0, 0, 0, 0.63)";
  }
};

$$.GalagaRenderer_subtleBgFade_anon20 = {"": "Closure;this_21",
  call$0: function() {
    this.this_21.get$game().set$bgStyle("rgba(0, 0, 0, 0.65)");
    return "rgba(0, 0, 0, 0.65)";
  }
};

$$.GalagaRenderer_subtleBgFade_anon21 = {"": "Closure;this_22",
  call$0: function() {
    this.this_22.get$game().set$bgStyle("rgba(0, 0, 0, 0.67)");
    return "rgba(0, 0, 0, 0.67)";
  }
};

$$.GalagaRenderer_subtleBgFade_anon22 = {"": "Closure;this_23",
  call$0: function() {
    this.this_23.get$game().set$bgStyle("rgba(0, 0, 0, 0.69)");
    return "rgba(0, 0, 0, 0.69)";
  }
};

$$.GalagaRenderer_subtleBgFade_anon23 = {"": "Closure;this_24",
  call$0: function() {
    this.this_24.get$game().set$bgStyle("rgba(0, 0, 0, 0.71)");
    return "rgba(0, 0, 0, 0.71)";
  }
};

$$.GalagaRenderer_subtleBgFade_anon24 = {"": "Closure;this_25",
  call$0: function() {
    this.this_25.get$game().set$bgStyle("rgba(0, 0, 0, 0.73)");
    return "rgba(0, 0, 0, 0.73)";
  }
};

$$.GalagaRenderer_subtleBgFade_anon25 = {"": "Closure;this_26",
  call$0: function() {
    this.this_26.get$game().set$bgStyle("rgba(0, 0, 0, 0.75)");
    return "rgba(0, 0, 0, 0.75)";
  }
};

$$.GalagaRenderer_subtleBgFade_anon26 = {"": "Closure;this_27",
  call$0: function() {
    this.this_27.get$game().set$bgStyle("rgba(0, 0, 0, 0.77)");
    return "rgba(0, 0, 0, 0.77)";
  }
};

$$.GalagaRenderer_subtleBgFade_anon27 = {"": "Closure;this_28",
  call$0: function() {
    this.this_28.get$game().set$bgStyle("rgba(0, 0, 0, 0.79)");
    return "rgba(0, 0, 0, 0.79)";
  }
};

$$.GalagaRenderer_subtleBgFade_anon28 = {"": "Closure;this_29",
  call$0: function() {
    this.this_29.get$game().set$bgStyle("rgba(0, 0, 0, 0.81)");
    return "rgba(0, 0, 0, 0.81)";
  }
};

$$.GalagaRenderer_subtleBgFade_anon29 = {"": "Closure;this_30",
  call$0: function() {
    this.this_30.get$game().set$bgStyle("rgba(0, 0, 0, 0.83)");
    return "rgba(0, 0, 0, 0.83)";
  }
};

$$.GalagaRenderer_subtleBgFade_anon30 = {"": "Closure;this_31",
  call$0: function() {
...
$$.Particles = {"": "GameEntity;_deleteTimer,_waiting@,game,_x,_y,_width,_height,isHighlighted,soundReady,id,groupId,box,previousBox,_removeFromGame,radius,momentum,enabled,opacity,color,fill,sprite",
  update$0: function() {
    if ($.$eq($.get$state$x(this.game), 2) === true)
      return;
    this._deleteTimer = $.Timer_Timer($.CONSTANT42, new $.Particles_update_anon(this));
...
$$.Ship = {"": "GameEntity;bulletPower,bullet@,maxBullet@,bulletsFired,bulletsHit@,lives@,soundLevel,chargedLevel@,superCharged,isPoweringUp,spiralShot@,superSpiral?,lastShotFired,game,_x,_y,_width,_height,isHighlighted,soundReady,id,groupId,box,previousBox,_removeFromGame,radius,momentum,enabled,opacity,color,fill,sprite",
  update$0: function() {
    ...
    if ($.$eq(t1.$index(t1, "spreadshot"), 1) === true)
      this.spiralShot = true;
    t1 = this.game.get$Options();
    if ($.$eq(t1.$index(t1, "controls"), 1) === true)
    ...
    if (t1.get$input().get$mouse() != null) {
      ...
      t1 = false;
    if (t1)
      this.set$x(this, this.game.get$input().get$mouse().x);
...
$.GameKeyboardEvent$ = function(keyCode, altKey, ctrlKey, shiftKey) {
  return new $.GameKeyboardEvent(keyCode, altKey, ctrlKey, shiftKey);
};
...
$.HtmlGameInput$ = function() {
  var t1 = new $.HtmlGameInput($.Set_Set(), $.Set_Set(), null, null, false, null, $.EventStream$(), $.EventStream$());
  t1.GameInput$0();
  return t1;
};
...
$.random = function(min, max, wholeNumbers) {
  var value = min + $.CONSTANT15.nextDouble$0() * (max - min);
...
$.EventStream$ = function() {
  var t1 = new $.EventStream($.StreamController$(null, null), null);
  t1.EventStream$0();
  return t1;
};
...
$.GalagaGame$withServices = function(input, renderer, loop) {
  var t1 = new $.GalagaGame(0, 0, 5, 5, 0, null, $.Map_Map(), $.Map_Map(), $.Map_Map(), $.Map_Map(), $.Map_Map(), $.Map_Map(), 1, 1, -400, -165, 3, 3, 1, 0, 33, 60, 1, null, true, null, null, 0, 1, 3, false, true, true, 1, null, 1, 0, $.GameSound$("Menu", 1, false), $.GameSound$("Options", 1, true), $.GameSound$("GameStart", 1, false), $.GameSound$("Game", 1, true), $.GameSound$("cursorMove", 0.3, false), $.GameSound$("cursorSelect", 0.3, false), $.GameSound$("cursorSelect2", 0.3, false), $.GameSound$("enemyFire", 0.3, false), $.GameSound$("enemyHit", 0.3, false), $.GameSound$("explosion", 0.3, false), $.GameSound$("mothershipfire", 0.3, false), $.GameSound$("shipFire", 0.3, false), $.GameSound$("shipHit", 0.3, false), $.GameSound$("powerUp", 0.3, false), $.EventStream$(), $.EventStream$(), $.EventStream$(), $.EventStream$(), $.EventStream$(), $.EventStream$(), $.EventStream$(), $.EventStream$(), null, null, null, null, null, input, renderer, loop, "rgba(0, 0, 0, .85)", false);
...
$.Enemy$ = function(game, x, y, diff, Type) {
  var t1 = new $.Enemy(null, false, false, 0, 0, 1, 1, 1, 100, 1, 100, false, false, 0, 1, game, 0, 0, 1, 1, false, false, null, null, null, null, false, null, null, true, 1, "255, 255, 255", true, null);
...
$.GalagaRenderer$ = function(targetId) {
  var t1 = new $.GalagaRenderer(0, $.ImageElement_ImageElement(null, null, null), $.ImageElement_ImageElement(null, null, null), $.ImageElement_ImageElement(null, null, null), $.ImageElement_ImageElement(null, null, null), $.ImageElement_ImageElement(null, null, null), $.ImageElement_ImageElement(null, null, null), $.ImageElement_ImageElement(null, null, null), $.ImageElement_ImageElement(null, null, null), $.ImageElement_ImageElement(null, null, null), $.ImageElement_ImageElement(null, null, null), $.ImageElement_ImageElement(null, null, null), $.ImageElement_ImageElement(null, null, null), $.ImageElement_ImageElement(null, null, null), $.ImageElement_ImageElement(null, null, null), $.ImageElement_ImageElement(null, null, null), $.ImageElement_ImageElement(null, null, null), $.ImageElement_ImageElement(null, null, null), $.ImageElement_ImageElement(null, null, null), $.ImageElement_ImageElement(null, null, null), $.ImageElement_ImageElement(null, null, null), $.ImageElement_ImageElement(null, null, null), $.ImageElement_ImageElement(null, null, null), $.ImageElement_ImageElement(null, null, null), $.ImageElement_ImageElement(null, null, null), false, false, targetId, null, null, null, null, null, null, null, null);
...
$.CONSTANT13 = new $.EventStreamProvider("mousemove");
$.CONSTANT26 = new $.Duration(175000);
$.CONSTANT38 = new $.Duration(575000);
$.CONSTANT10 = new $.EventStreamProvider("keydown");
$.CONSTANT2 = new $._LinkedHashTableHeadMarker();
$.CONSTANT16 = new $.Duration(250000);
$.CONSTANT41 = new $.Duration(650000);
$.CONSTANT12 = new $.EventStreamProvider("touchmove");
$.CONSTANT29 = new $.Duration(325000);
...
$.CONSTANT31 = new $.Duration(400000);
$.CONSTANT = new $.NullThrownError();
$.CONSTANT11 = new $.EventStreamProvider("touchstart");
$.CONSTANT43 = new $.EventStreamProvider("webkitpointerlockchange");
$.CONSTANT28 = new $.Duration(275000);
$.JSDouble_methods = $.JSDouble.prototype;
$.CONSTANT30 = new $.Duration(350000);
$.CONSTANT32 = new $.Duration(425000);
$.CONSTANT5 = new $.CloseToken();
$.CONSTANT18 = new $.Duration(25000);
$.CONSTANT24 = new $.Duration(100000);
$.CONSTANT35 = new $.Duration(500000);
...
$.CONSTANT33 = new $.Duration(450000);
$.CONSTANT25 = new $.Duration(125000);
$.CONSTANT9 = new $.EventStreamProvider("keyup");
$.CONSTANT36 = new $.Duration(525000);
$.CONSTANT27 = new $.Duration(200000);
$.CONSTANT39 = new $.Duration(600000);
$.CONSTANT42 = new $.Duration(1000000);
$.CONSTANT15 = new $._Random();
$.CONSTANT19 = new $.Duration(75000);
$.CONSTANT34 = new $.Duration(475000);
$.CONSTANT20 = new $.Duration(150000);
$.CONSTANT37 = new $.Duration(550000);
$.CONSTANT7 = new $.EventStreamProvider("mouseup");
$.CONSTANT40 = new $.Duration(625000);
$.CONSTANT21 = new $.Duration(225000);
$.JSInt_methods = $.JSInt.prototype;
$.CONSTANT44 = new $._DelayedDone();
...
$.get$$$dom_webkitPointerLockElement$x = function(receiver) {
  return $.getInterceptor$x(receiver).get$$$dom_webkitPointerLockElement(receiver);
};
...
$.get$onPointerLockChange$x = function(receiver) {
  return $.getInterceptor$x(receiver).get$onPointerLockChange(receiver);
};
...
$.get$pointerLockElement$x = function(receiver) {
  return $.getInterceptor$x(receiver).get$pointerLockElement(receiver);
};
...
$.$defineNativeClass("Document", {"": "$$dom_body:body=,$$dom_webkitPointerLockElement:webkitPointerLockElement=",
  ...
  get$onPointerLockChange: function(receiver) {
    return $.CONSTANT43.forTarget$1(receiver);
  }
});
...
$.$defineNativeClass("HTMLDocument", {
  ...
  get$pointerLockElement: function(receiver) {
    return $.get$$$dom_webkitPointerLockElement$x($.document());
  }
});
...
$.$defineNativeClass("KeyboardEvent", {"": "altKey=,ctrlKey=,shiftKey=",
...
$.$defineNativeClass("MouseEvent", {"": "altKey=,ctrlKey=,shiftKey=",
...
$.$defineNativeClass("TouchEvent", {"": "altKey=,ctrlKey=,shiftKey=,touches="});
