...
$$.GalagaGame = {"": "Game;score@,highScore,lastPowerUp,lastEnemy,lastStar,_liblib3$_state,Stats<,Options<,Controls,Highscores<,HighscoresRank,Cheats<,rank,pointMultiplier@,enemyX?,enemyY?,bulletCap,shipStartLives,colorCount,enemyCount,enemyAmount@,defaultTimer,level@,p1Dead?,goingRight,_countdownTimer,_waitingTimer,_waiting@,difficulty@,bonusCheck@,bonusStage@,soundEffectsOn@,tutorial?,visualLevel<,ship<,nextId,targetId@,menuSong<,optionSong,gameStart,gameSong,cursorMove<,cursorSelect<,cursorSelect2<,enemyFire<,enemyHit<,explosion,motherShipFire<,shipFire<,shipHit<,powerUp<,_statUpdateEvent<,_gameOverEvent,_shipHitEvent<,_bossHitEvent<,_bossKilledEvent,_motherShipEvent<,_normalHitEvent<,_fadeEvent<,entities,sounds,timer,clockTick,rect,input,renderer,loop,bgStyle,showOutlines",
  ...
  newStar$0: function() {
    var w, t1, star;
    if ($.random(0, 1, false) > 0.2 || this.get$state(this) === 2)
      return;
    w = $.random(0.5, 3.5, false);
    t1 = this.colorCount;
    if (t1 < 7) {
      this.colorCount = $.random(1, 7, false);
      $.JSNumber_methods.ceil$0(this.colorCount);
    } else if (t1 >= 7)
      this.colorCount = 1;
    star = $.Stars$(this, 0, 0, w, w, this.colorCount);
  ...
  createCheatsMenu$0: function() {
    ...
    this.entities.push(t2);
    t2 = $.$eq(t1.$index(t1, "invincibility"), 1) === true ? "True" : "False";
    t2 = $.GameButton$(new $.GalagaGame_createCheatsMenu_anon0(this), true, "255, 255, 255", "cinnamoncake, Verdana", this, "cheats", "", 0.7, 36, t2, 200, -64);
    this.entities.push(t2);
    t2 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "cheats", "", 0.7, 36, "Freeze Enemy:", -38, -34);
    this.entities.push(t2);
    t1 = $.$eq(t1.$index(t1, "freeze"), 1) === true ? "True" : "False";
    t1 = $.GameButton$(new $.GalagaGame_createCheatsMenu_anon1(this), true, "255, 255, 255", "cinnamoncake, Verdana", this, "cheats", "", 0.7, 36, t1, 200, -34);
    this.entities.push(t1);
    t1 = $.GameButton$(new $.GalagaGame_createCheatsMenu_anon2(this), true, "255, 255, 255", "cinnamoncake, Verdana", this, "cheats", "", 0.7, 16, "Made by Cody Smith", 400, 275);
    this.entities.push(t1);
    this.disableEntitiesByGroup$1("cheats");
  },
  ...
  createWelcomeMenu$0: function() {
    ...
    if ($.$ge$n(t1.$index(t1, 1), 400000) === true)
      this.rank = 17;
    t1 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "welcome", "", this.rank === 1 ? 0.65 : 0, 36, "You're: The Jew", 0, -275);
    this.entities.push(t1);
    t1 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "welcome", "", this.rank === 2 ? 0.65 : 0, 36, "You're: The Jewish Priest", 0, -275);
    this.entities.push(t1);
    t1 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "welcome", "", this.rank === 3 ? 0.65 : 0, 36, "You're: The Amish Mastermind", 0, -275);
    this.entities.push(t1);
    t1 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "welcome", "", this.rank === 4 ? 0.65 : 0, 36, "You're: The Road Warrior", 0, -275);
    this.entities.push(t1);
    t1 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "welcome", "", this.rank === 5 ? 0.65 : 0, 36, "You're: The Space Recruit", 0, -275);
    this.entities.push(t1);
    t1 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "welcome", "", this.rank === 6 ? 0.65 : 0, 36, "You're: The Space Cadet", 0, -275);
    this.entities.push(t1);
    t1 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "welcome", "", this.rank === 7 ? 0.65 : 0, 36, "You're: The Space Captain", 0, -275);
    this.entities.push(t1);
    t1 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "welcome", "", this.rank === 8 ? 0.65 : 0, 36, "You're: The Overlord of the Galaxy", 0, -275);
    this.entities.push(t1);
    t1 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "welcome", "", this.rank === 9 ? 0.65 : 0, 36, "You're: The President of the Universe", 0, -275);
    this.entities.push(t1);
    t1 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "welcome", "", this.rank === 10 ? 0.65 : 0, 36, "You're: The Commander of the Universe", 0, -275);
    this.entities.push(t1);
    t1 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "welcome", "", this.rank === 11 ? 0.65 : 0, 36, "You're: The Overlord of the Universe", 0, -275);
    this.entities.push(t1);
    t1 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "welcome", "", this.rank === 12 ? 0.65 : 0, 36, "You're: The Overseer of the Multi-verse", 0, -275);
    this.entities.push(t1);
    t1 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "welcome", "", this.rank === 13 ? 0.65 : 0, 36, "You're: The Commander of the Multi-verse", 0, -275);
    this.entities.push(t1);
    t1 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "welcome", "", this.rank === 14 ? 0.65 : 0, 36, "You're: The Overlord of the Multi-verse", 0, -275);
    this.entities.push(t1);
    t1 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "welcome", "", this.rank === 15 ? 0.65 : 0, 36, "You're: The God of this Dimension", 0, -275);
    this.entities.push(t1);
    t1 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "welcome", "", this.rank === 16 ? 0.65 : 0, 36, "You're: The God of all Dimensions", 0, -275);
    this.entities.push(t1);
    t1 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "welcome", "", this.rank === 17 ? 0.65 : 0, 36, "You're: Pablo Manrequez De Montoya De La Qruez the Third", 0, -275);
    this.entities.push(t1);
  ...
  createLeaderBoardMenu$0: function() {
    ...
    this.entities.push(t3);
    t3 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "leaders", "", 0.7, 42, "1st: " + $.S(t2.$index(t2, 1)), -160, -135);
    this.entities.push(t3);
    t3 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "leaders", "", 0.7, 42, $.S(t1.$index(t1, 1)), 160, -135);
    this.entities.push(t3);
    t3 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "leaders", "", 0.7, 42, "2nd: " + $.S(t2.$index(t2, 2)), -160, -95);
    this.entities.push(t3);
    t3 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "leaders", "", 0.7, 42, $.S(t1.$index(t1, 2)), 160, -95);
    this.entities.push(t3);
    t3 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "leaders", "", 0.7, 42, "3rd: " + $.S(t2.$index(t2, 3)), -160, -55);
    this.entities.push(t3);
    t3 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "leaders", "", 0.7, 42, $.S(t1.$index(t1, 3)), 160, -55);
    this.entities.push(t3);
    t3 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "leaders", "", 0.7, 42, "4th: " + $.S(t2.$index(t2, 4)), -160, -15);
    this.entities.push(t3);
    t3 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "leaders", "", 0.7, 42, $.S(t1.$index(t1, 4)), 160, -15);
    this.entities.push(t3);
    t3 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "leaders", "", 0.7, 42, "5th: " + $.S(t2.$index(t2, 5)), -160, 25);
    this.entities.push(t3);
    t3 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "leaders", "", 0.7, 42, $.S(t1.$index(t1, 5)), 160, 25);
    this.entities.push(t3);
    t3 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "leaders", "", 0.7, 42, "6th: " + $.S(t2.$index(t2, 6)), -160, 65);
    this.entities.push(t3);
    t3 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "leaders", "", 0.7, 42, $.S(t1.$index(t1, 6)), 160, 65);
    this.entities.push(t3);
    t3 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "leaders", "", 0.7, 42, "7th: " + $.S(t2.$index(t2, 7)), -160, 105);
    this.entities.push(t3);
    t3 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "leaders", "", 0.7, 42, $.S(t1.$index(t1, 7)), 160, 105);
    this.entities.push(t3);
    t3 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "leaders", "", 0.7, 42, "8th: " + $.S(t2.$index(t2, 8)), -160, 145);
    this.entities.push(t3);
    t3 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "leaders", "", 0.7, 42, $.S(t1.$index(t1, 8)), 160, 145);
    this.entities.push(t3);
    t3 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "leaders", "", 0.7, 42, "9th: " + $.S(t2.$index(t2, 9)), -160, 185);
    this.entities.push(t3);
    t3 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "leaders", "", 0.7, 42, $.S(t1.$index(t1, 9)), 160, 185);
    this.entities.push(t3);
    t3 = $.GameText$(true, "255, 255, 255", "cinnamoncake, Verdana", this, "leaders", "", 0.8, 42, "10th: " + $.S(t2.$index(t2, 10)), -160, 225);
    this.entities.push(t3);
...
$$.GalagaGame_getEnemyX_anon0 = {"": "Closure;type_0",
  call$1: function(e) {
    var t1 = $.getInterceptor$x(e);
    if ($.$eq(t1.get$type(e), this.type_0) === true)
      return t1.get$x(e);
  }
};
...
$$.GalagaGame_createCheatsMenu_anon1 = {"": "Closure;this_2",
  call$0: function() {
    ...
    t1 = this.this_2;
    t2 = t1.get$Cheats();
    t3 = $.$ge$n(t2.$index(t2, "freeze"), 2);
    t4 = t1.get$Cheats();
    if (t3 === true)
      t4.$indexSet(t4, "freeze", 1);
    else
      t4.$indexSet(t4, "freeze", $.$add$ns(t4.$index(t4, "freeze"), 1));
    t1.get$_statUpdateEvent().signal$0();
    t2 = $.getInterceptor$x(t1);
    t2.set$state(t1, 1);
    t1.removeEntitiesByGroup$1("cheats");
...
$$.GalagaGame_createCheatsMenu_anon2 = {"": "Closure;this_3",
  call$0: function() {
    var t1 = this.this_3;
...
$$.GalagaGame_canEnemyFall_anon0 = {"": "Closure;box_0",
  call$1: function(e) {
    var t1;
    if ($.$eq($.get$type$x(e), "Normal") === true) {
      t1 = this.box_0;
      t1.x_0 = $.$add$ns(t1.x_0, 1);
    }
  }
...
$$.GalagaRenderer = {"": "CanvasGameRenderer;timeLeft,ship<,enemy<,enemy2<,boss<,mothership<,bosshp<,spreadup<,lifeup<,multiplierup<,bulletup<,coin<,shipbullet<,enemybullet<,superBullet<,bossSuperBullet<,chargeBar,star1<,star2<,star3<,star4<,star5<,star6<,star7<,skull<,enemyFlicker,shipFlicker?,targetId,ctx,defaultRenderer,assetManager,textRenderer,ownMouse,canvas,_game,rect",
  ...
  updateStats$0: function() {
    ...
    t1 = window.localStorage;
    t28 = this.get$game().get$Options();
    $.$indexSet$ax(t1, "win9", $.toString$0(t28.$index(t28, "spreadshot")));
    t1 = window.localStorage;
    t29 = this.get$game().get$Options();
    $.$indexSet$ax(t1, "win10", $.toString$0(t29.$index(t29, "invincibility")));
    t1 = window.localStorage;
    t30 = this.get$game().get$Options();
    $.$indexSet$ax(t1, "win11", $.toString$0(t30.$index(t30, "freeze")));
  },
  bossHit$0: function() {
  ...
  drawCountDown$0: function() {
    ...
    if (t1.get$state(t1) === 8) {
      ...
      if (this.get$game().get$waiting() === 1)
        temp = 3;
      else if (this.get$game().get$waiting() === 2)
        temp = 2;
      else
        temp = this.get$game().get$waiting() === 3 ? 1 : 0;
